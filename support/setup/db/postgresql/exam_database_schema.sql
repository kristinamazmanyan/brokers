...
ALTER TABLE public.permission OWNER TO exam;
...
ALTER TABLE public.role OWNER TO exam;
...
ALTER TABLE public.role_permissions OWNER TO exam;
...
ALTER TABLE public.user OWNER TO exam;
...
ALTER TABLE public.user_roles OWNER TO exam;
...
ALTER TABLE public.event OWNER TO exam;
...
ALTER TABLE public.rf_exam_type OWNER TO exam;
...
ALTER TABLE public.rf_exam_time OWNER TO exam;
...
ALTER TABLE public.rf_exam_condition OWNER TO exam;
...
ALTER TABLE public.exams OWNER TO exam;
...
ALTER TABLE public.committee_members OWNER TO exam;
...
ALTER TABLE public.rf_examinator_position OWNER TO exam;
...
ALTER TABLE public.exam_members OWNER TO exam;
...
ALTER TABLE public.exam_questions OWNER TO exam;
...
ALTER TABLE public.exam_sectors OWNER TO exam;
...
ALTER TABLE public.quiz_results OWNER TO exam;
...
ALTER TABLE public.quiz_final_result OWNER TO exam;
